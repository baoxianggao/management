...
(function (global, factory) {
  ...
  var Sizzle = function (window) {
    ...
    function testContext(context) {
      return context && (0, _typeof3.default)(context.getElementsByTagName) !== strundefined && context;
    }
    ...
    setDocument = Sizzle.setDocument = function (node) {
      ...
      if (support.getById) {
        Expr.find["ID"] = function (id, context) {
          if ((0, _typeof3.default)(context.getElementById) !== strundefined && documentIsHTML) {
      ...
      Expr.find["CLASS"] = support.getElementsByClassName && function (className, context) {
        if ((0, _typeof3.default)(context.getElementsByClassName) !== strundefined && documentIsHTML) {
      ...
      filter: {
        ...
        "CLASS": function CLASS(className) {
          ...
          return pattern || (pattern = new RegExp("(^|" + whitespace + ")" + className + "(" + whitespace + "|$)")) && classCache(className, function (elem) {
            return pattern.test(typeof elem.className === "string" && elem.className || (0, _typeof3.default)(elem.getAttribute) !== strundefined && elem.getAttribute("class") || "");
          });
        },
